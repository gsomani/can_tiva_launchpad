...
char rx_message[8],tx_message[8];
int t=0,rx_id,tx_id,rx_len,tx_len,rtr_id=1,rx_obj=1,tx_obj=2; uint32_t bitrate=500000,tx_count=0,rx_count=0;
...
bool read_frame(char frame[],int *id,bool *remote,int *len,char *msg){
